...
function ciniki_exhibitions_participantCategorySearch($ciniki) {
    ...
    $rc = ciniki_exhibitions_checkAccess($ciniki, $args['tnid'], 'ciniki.exhibitions.participantCategorySearch', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $strsql = "SELECT DISTINCT ciniki_exhibition_participants.category AS name "
        ...
        . "WHERE ciniki_exhibition_participants.tnid = '" . ciniki_core_dbQuote($ciniki, $args['tnid']) . "' "
        . "";
